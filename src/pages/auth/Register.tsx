...
const Register: React.FC = () => {
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold text-neutral-900 mb-2">Регистрация</h2>
      <p className="text-neutral-600 mb-8">
        Создайте учетную запись, чтобы начать работу с системой
      </p>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        <div>
          ...
          />
          {errors.fullName && (
            <p className="mt-1 text-sm text-accent-600">{errors.fullName.message}</p>
          )}
        </div>
